...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, null, null, 14, 0, null, 29, 45, 50, 18, 19, 27, 36],
    ...
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 5, 0, 2, 6],
    ...
    _rootFork: [function($self, $parent, zone, specification, zoneValues) {
      ...
      return t1;
    }, "call$5", "async___rootFork$closure", 10, 0, 53, 7, 8, 5, 58, 37],
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 5, 0, 2, 6],
    ...
    HtmlElement: {
      "^": "Element;",
      $isHtmlElement: 1,
      "%": "HTMLBRElement|HTMLBaseElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLDivElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFontElement|HTMLFrameElement|HTMLHRElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMenuItemElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPictureElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLShadowElement|HTMLSlotElement|HTMLSourceElement|HTMLSpanElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableDataCellElement|HTMLTableElement|HTMLTableHeaderCellElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTemplateElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement|HTMLUnknownElement;HTMLElement"
    },
    AnchorElement: {
      "^": "HtmlElement;",
      toString$0: function(receiver) {
    ...
    coreLoadAndBootstrap_closure: {
      "^": "Closure:12;injector,componentType,appRef",
      call$0: function() {
    ...
    initReflector_closure13: {
      ...
      }, null, null, 6, 0, null, 3, 13, 24, "call"]
    }
    ...
    AppView: {
      ...
      project$2: function(parentElement, index) {
        var projectableNodes, projectables, t1, i, projectable;
        ...
        for (t1 = J.getInterceptor$x(parentElement), i = 0; i < 1; ++i) {
          projectable = projectables[i];
          t1.append$1(parentElement, projectable);
        }
        $.domRootRendererIsDirty = true;
      },
    ...
    _RuntimeInjector: {
      ...
      }, "useClass$1", "call$2$deps", "call$1", "get$useClass", 2, 3, 34, 0, 44, 25],
      ...
      }, "useFactory$1", "call$2$deps", "call$1", "get$useFactory", 2, 3, 36, 0, 46, 25],
    ...
    BrowserGetTestability_addToWindow_closure: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 53, 20, 26, "call"]
    },
  ...
  }], ["", "package:component_styles/app_component.dart",, Q, {
    "^": "",
    AppComponent: {
      "^": "Object;hero",
  ...
  }], ["", "package:component_styles/app_component.template.dart",, V, {
    "^": "",
    ...
    initReflector1: function() {
      ...
      E.initReflector0();
      N.initReflector2();
      $.$get$_components().$indexSet(0, C.Type_AppComponent_TyU, C.ComponentFactory_hkD);
    },
    ViewAppComponent0: {
      "^": "AppView;_app_component_template$_el_0,_app_component_template$_el_2,_app_component_template$_compView_2,_HeroAppMainComponent_2_4,_app_component_template$_expr_0,_app_component_template$_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var parentRenderNode, doc, t1, _text_1, t2;
        ...
        this.addShimE$1(t1);
        _text_1 = doc.createTextNode("Tour of Heroes");
        J.append$1$x(this._app_component_template$_el_0, _text_1);
        t1 = N.ViewHeroAppMainComponent0$(this, 2);
        this._app_component_template$_compView_2 = t1;
        t1 = t1.rootEl;
        this._app_component_template$_el_2 = t1;
        J.append$1$x(parentRenderNode, t1);
        this.addShimC$1(this._app_component_template$_el_2);
        t1 = new V.HeroAppMainComponent(null);
        this._HeroAppMainComponent_2_4 = t1;
        t2 = this._app_component_template$_compView_2;
        t2.toString;
      ...
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_HeroAppMainComponent_P1W && 2 === nodeIndex)
          return this._HeroAppMainComponent_2_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var currVal_0 = H.interceptedTypeCheck(this.ctx, "$isAppComponent").hero;
        if (this._app_component_template$_expr_0 !== currVal_0) {
          this._HeroAppMainComponent_2_4.hero = currVal_0;
          this._app_component_template$_expr_0 = currVal_0;
        }
        this._app_component_template$_compView_2.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._app_component_template$_compView_2;
        if (!(t1 == null))
          t1.destroy$0();
      },
      $asAppView: function() {
    ...
    _ViewAppComponentHost0: {
      ...
      build$0: function() {
        var t1, t2, t3, t4;
        t1 = P.String;
        t2 = new V.ViewAppComponent0(null, null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [t1, null], "$asMap"), this, null, null, null);
        t2.set$viewData(S.AppViewData_AppViewData(t2, 3, C.ViewType_1, 0, null));
        t3 = document.createElement("hero-app");
        t2.rootEl = H.interceptedTypeCheck(t3, "$isHtmlElement");
        t3 = $.ViewAppComponent0__renderType;
        if (t3 == null) {
          t3 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_2bx);
          $.ViewAppComponent0__renderType = t3;
        }
        t2.setupComponentType$1(t3);
        this._compView_0 = t2;
        this.rootEl = t2.rootEl;
        t1 = new Q.AppComponent(new G.Hero(false, "Human Torch", H.assertSubtype(["Mister Fantastic", "Invisible Woman", "Thing"], "$isList", [t1], "$asList")));
        this._AppComponent_0_4 = t1;
        t3 = this.viewData.projectableNodes;
        t4 = Q.AppComponent;
        H.assertSubtypeOfRuntimeType(t1, t4);
        t2.set$ctx(t1);
      ...
      detectChangesInternal$0: function() {
        var t1, currVal_1, t2, hostClass, t3;
        this.viewData._cdState;
        t1 = this._compView_0;
        currVal_1 = t1.ctx.get$themeClass();
        if (t1._app_component_template$_expr_1 !== currVal_1) {
          t2 = t1.rootEl;
          hostClass = t1.componentType._hostAttr;
          t2.className = hostClass == null ? currVal_1 : currVal_1 + " " + hostClass;
          t3 = t1.parentView;
          if (t3 != null && t3.componentType != null)
            t3.addShimE$1(t2);
          t1._app_component_template$_expr_1 = currVal_1;
        }
  ...
  }], ["", "package:component_styles/src/hero.dart",, G, {
    "^": "",
    Hero: {
      "^": "Object;active,name,team"
    }
  }], ["", "package:component_styles/src/hero_app_main_component.dart",, V, {
    "^": "",
    HeroAppMainComponent: {
      "^": "Object;hero"
    }
  }], ["", "package:component_styles/src/hero_app_main_component.template.dart",, N, {
    "^": "",
    viewFactory_HeroAppMainComponentHost0: [function(parentView, parentIndex) {
      var t1 = new N._ViewHeroAppMainComponentHost0(null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex, null));
      return t1;
    }, "call$2", "hero_app_main_component_template__viewFactory_HeroAppMainComponentHost0$closure", 4, 0, 4],
    initReflector2: function() {
      ...
      E.initReflector0();
      S.initReflector5();
      $.$get$_components().$indexSet(0, C.Type_HeroAppMainComponent_P1W, C.ComponentFactory_QoR);
    },
    ViewHeroAppMainComponent0: {
      "^": "AppView;_hero_app_main_component_template$_el_0,_hero_app_main_component_template$_compView_0,_hero_app_main_component_template$_QuestSummaryComponent_0_4,_el_1,_compView_1,_HeroDetailsComponent_1_4,_hero_app_main_component_template$_el_2,_hero_app_main_component_template$_compView_2,_HeroControlsComponent_2_4,_hero_app_main_component_template$_expr_0,_hero_app_main_component_template$_expr_1,_expr_2,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewHeroAppMainComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("hero-app-main");
        this.rootEl = H.interceptedTypeCheck(t1, "$isHtmlElement");
        t1 = $.ViewHeroAppMainComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_1, C.List_empty0);
          $.ViewHeroAppMainComponent0__renderType = t1;
        }
      ...
      build$0: function() {
        ...
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        t1 = S.ViewQuestSummaryComponent0$(this, 0);
        this._hero_app_main_component_template$_compView_0 = t1;
        t1 = t1.rootEl;
        this._hero_app_main_component_template$_el_0 = t1;
        t2 = J.getInterceptor$x(parentRenderNode);
        t2.append$1(parentRenderNode, t1);
        t1 = new X.QuestSummaryComponent();
        this._hero_app_main_component_template$_QuestSummaryComponent_0_4 = t1;
        t3 = this._hero_app_main_component_template$_compView_0;
        t3.toString;
        H.assertSubtypeOfRuntimeType(t1, H.getRuntimeTypeArgument(t3, "AppView", 0));
        t3.set$ctx(t1);
        t3.viewData.projectableNodes = [];
        t3.build$0();
        t3 = Q.ViewHeroDetailsComponent0$(this, 1);
        this._compView_1 = t3;
        t3 = t3.rootEl;
        this._el_1 = t3;
        t2.append$1(parentRenderNode, t3);
        this._HeroDetailsComponent_1_4 = new U.HeroDetailsComponent(null);
        t3 = T.ViewHeroControlsComponent0$(this, 2);
        this._hero_app_main_component_template$_compView_2 = t3;
        this._hero_app_main_component_template$_el_2 = t3.rootEl;
        t2 = new R.HeroControlsComponent(null);
        this._HeroControlsComponent_2_4 = t2;
        H.assertSubtypeOfRuntimeType(t2, H.getRuntimeTypeArgument(t3, "AppView", 0));
        t3.set$ctx(t2);
        t3.viewData.projectableNodes = [];
        t3.build$0();
        t3 = this._compView_1;
        t2 = this._HeroDetailsComponent_1_4;
        t1 = this._hero_app_main_component_template$_el_2;
        t3.toString;
        H.assertSubtypeOfRuntimeType(t2, H.getRuntimeTypeArgument(t3, "AppView", 0));
        t3.set$ctx(t2);
        t3.viewData.projectableNodes = [[t1]];
        t3.build$0();
        this.init$2(C.List_empty0, null);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_QuestSummaryComponent_guV && 0 === nodeIndex)
          return this._hero_app_main_component_template$_QuestSummaryComponent_0_4;
        if (token === C.Type_HeroControlsComponent_soA && 2 === nodeIndex)
          return this._HeroControlsComponent_2_4;
        if (token === C.Type_HeroDetailsComponent_MU4 && 1 <= nodeIndex && nodeIndex <= 2)
          return this._HeroDetailsComponent_1_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var currVal_1, t1, currVal_0;
        currVal_1 = H.interceptedTypeCheck(this.ctx, "$isHeroAppMainComponent").hero;
        t1 = this._hero_app_main_component_template$_expr_1;
        if (t1 == null ? currVal_1 != null : t1 !== currVal_1) {
          this._HeroDetailsComponent_1_4.hero = currVal_1;
          this._hero_app_main_component_template$_expr_1 = currVal_1;
        }
        t1 = this._expr_2;
        if (t1 == null ? currVal_1 != null : t1 !== currVal_1) {
          this._HeroControlsComponent_2_4.hero = currVal_1;
          this._expr_2 = currVal_1;
        }
        currVal_0 = currVal_1.active;
        if (this._hero_app_main_component_template$_expr_0 !== currVal_0) {
          t1 = this._el_1;
          if (currVal_0)
            t1.classList.add("active");
          else
            t1.classList.remove("active");
          this._hero_app_main_component_template$_expr_0 = currVal_0;
        }
        this._hero_app_main_component_template$_compView_0.detectChanges$0();
        this._compView_1.detectChanges$0();
        this._hero_app_main_component_template$_compView_2.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._hero_app_main_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_1;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._hero_app_main_component_template$_compView_2;
        if (!(t1 == null))
          t1.destroy$0();
      },
      $asAppView: function() {
        return [V.HeroAppMainComponent];
      },
      static: {
        ViewHeroAppMainComponent0$: function(parentView, parentIndex) {
          var t1 = new N.ViewHeroAppMainComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
          t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex, null));
          t1.ViewHeroAppMainComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewHeroAppMainComponentHost0: {
      "^": "AppView;_hero_app_main_component_template$_compView_0,_HeroAppMainComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = N.ViewHeroAppMainComponent0$(this, 0);
        this._hero_app_main_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new V.HeroAppMainComponent(null);
        this._HeroAppMainComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        ...
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroAppMainComponent_0_4, [V.HeroAppMainComponent]);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_HeroAppMainComponent_P1W && 0 === nodeIndex)
          return this._HeroAppMainComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._hero_app_main_component_template$_compView_0.detectChanges$0();
  ...
  }], ["", "package:component_styles/src/hero_controls_component.dart",, R, {
    "^": "",
    HeroControlsComponent: {
      "^": "Object;hero",
      activate$0: [function(_) {
        this.hero.active = true;
      }, "call$0", "get$activate", 0, 0, 2]
    }
  }], ["", "package:component_styles/src/hero_controls_component.template.dart",, T, {
    "^": "",
    viewFactory_HeroControlsComponentHost0: [function(parentView, parentIndex) {
      var t1 = new T._ViewHeroControlsComponentHost0(null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex, null));
      return t1;
    }, "call$2", "hero_controls_component_template__viewFactory_HeroControlsComponentHost0$closure", 4, 0, 4],
    initReflector3: function() {
      if ($._visited5)
        return;
      $._visited5 = true;
      E.initReflector0();
      $.$get$_components().$indexSet(0, C.Type_HeroControlsComponent_soA, C.ComponentFactory_af1);
    },
    ViewHeroControlsComponent0: {
      "^": "AppView;_el_0,_el_2,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewHeroControlsComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("hero-controls");
        this.rootEl = H.interceptedTypeCheck(t1, "$isHtmlElement");
        t1 = $.ViewHeroControlsComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_gc6);
          $.ViewHeroControlsComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, _text_1, _text_3, t2;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createAndAppend(doc, "h3", parentRenderNode);
        this._el_0 = t1;
        this.addShimE$1(t1);
        _text_1 = doc.createTextNode("Controls");
        J.append$1$x(this._el_0, _text_1);
        t1 = H.interceptedTypeCheck(S.createAndAppend(doc, "button", parentRenderNode), "$isButtonElement");
        this._el_2 = t1;
        this.addShimC$1(t1);
        _text_3 = doc.createTextNode("Activate");
        t1 = this._el_2;
        (t1 && C.ButtonElement_methods).append$1(t1, _text_3);
        t1 = this._el_2;
        t2 = this.eventHandler0$1(J.get$activate$x(this.ctx));
        t1.toString;
      ...
      $asAppView: function() {
        return [R.HeroControlsComponent];
      },
      static: {
        ViewHeroControlsComponent0$: function(parentView, parentIndex) {
          var t1 = new T.ViewHeroControlsComponent0(null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
          t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex, null));
          t1.ViewHeroControlsComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewHeroControlsComponentHost0: {
      "^": "AppView;_hero_controls_component_template$_compView_0,_HeroControlsComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = T.ViewHeroControlsComponent0$(this, 0);
        this._hero_controls_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new R.HeroControlsComponent(null);
        this._HeroControlsComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        H.assertSubtypeOfRuntimeType(t2, H.getRuntimeTypeArgument(t1, "AppView", 0));
        t1.set$ctx(t2);
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroControlsComponent_0_4, [R.HeroControlsComponent]);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_HeroControlsComponent_soA && 0 === nodeIndex)
          return this._HeroControlsComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._hero_controls_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._hero_controls_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      },
      $asAppView: Isolate.functionThatReturnsNull
    }
  }], ["", "package:component_styles/src/hero_details_component.dart",, U, {
    "^": "",
    HeroDetailsComponent: {
      "^": "Object;hero"
    }
  }], ["", "package:component_styles/src/hero_details_component.template.dart",, Q, {
    "^": "",
    viewFactory_HeroDetailsComponentHost0: [function(parentView, parentIndex) {
      var t1 = new Q._ViewHeroDetailsComponentHost0(null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex, null));
      return t1;
    }, "call$2", "hero_details_component_template__viewFactory_HeroDetailsComponentHost0$closure", 4, 0, 4],
    initReflector4: function() {
      ...
      M.initReflector6();
      E.initReflector0();
      $.$get$_components().$indexSet(0, C.Type_HeroDetailsComponent_MU4, C.ComponentFactory_AZi);
    },
    ViewHeroDetailsComponent0: {
      "^": "AppView;_hero_details_component_template$_el_0,_hero_details_component_template$_text_1,_hero_details_component_template$_el_2,_compView_2,_HeroTeamComponent_2_4,_hero_details_component_template$_expr_0,_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewHeroDetailsComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("hero-details");
        this.rootEl = H.interceptedTypeCheck(t1, "$isHtmlElement");
        t1 = $.ViewHeroDetailsComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_pSP);
          $.ViewHeroDetailsComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        this._hero_details_component_template$_el_0 = t1;
        this.addShimE$1(t1);
        t1 = doc.createTextNode("");
        this._hero_details_component_template$_text_1 = t1;
        J.append$1$x(this._hero_details_component_template$_el_0, t1);
        t1 = M.ViewHeroTeamComponent0$(this, 2);
        this._compView_2 = t1;
        t1 = t1.rootEl;
        this._hero_details_component_template$_el_2 = t1;
        J.append$1$x(parentRenderNode, t1);
        this.addShimC$1(this._hero_details_component_template$_el_2);
        t1 = new V.HeroTeamComponent(null);
        this._HeroTeamComponent_2_4 = t1;
        t2 = this._compView_2;
        t2.toString;
        H.assertSubtypeOfRuntimeType(t1, H.getRuntimeTypeArgument(t2, "AppView", 0));
        t2.set$ctx(t1);
      ...
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_HeroTeamComponent_ckJ && 2 === nodeIndex)
          return this._HeroTeamComponent_2_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var currVal_1, t1, currVal_0;
        currVal_1 = H.interceptedTypeCheck(this.ctx, "$isHeroDetailsComponent").hero;
        t1 = this._expr_1;
        if (t1 == null ? currVal_1 != null : t1 !== currVal_1) {
          this._HeroTeamComponent_2_4.hero = currVal_1;
          this._expr_1 = currVal_1;
        }
        currVal_0 = Q.interpolate0(currVal_1.name);
        if (this._hero_details_component_template$_expr_0 !== currVal_0) {
          this._hero_details_component_template$_text_1.textContent = currVal_0;
          this._hero_details_component_template$_expr_0 = currVal_0;
        }
      ...
      $asAppView: function() {
        return [U.HeroDetailsComponent];
      },
      static: {
        ViewHeroDetailsComponent0$: function(parentView, parentIndex) {
          var t1 = new Q.ViewHeroDetailsComponent0(null, null, null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
          t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex, null));
          t1.ViewHeroDetailsComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewHeroDetailsComponentHost0: {
      "^": "AppView;_hero_details_component_template$_compView_0,_HeroDetailsComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = Q.ViewHeroDetailsComponent0$(this, 0);
        this._hero_details_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new U.HeroDetailsComponent(null);
        this._HeroDetailsComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        H.assertSubtypeOfRuntimeType(t2, H.getRuntimeTypeArgument(t1, "AppView", 0));
        t1.set$ctx(t2);
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroDetailsComponent_0_4, [U.HeroDetailsComponent]);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_HeroDetailsComponent_MU4 && 0 === nodeIndex)
          return this._HeroDetailsComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._hero_details_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._hero_details_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      },
      $asAppView: Isolate.functionThatReturnsNull
    }
  }], ["", "package:component_styles/src/hero_team_component.dart",, V, {
    "^": "",
    HeroTeamComponent: {
      "^": "Object;hero"
    }
  }], ["", "package:component_styles/src/hero_team_component.template.dart",, M, {
    "^": "",
    viewFactory_HeroTeamComponent1: [function(parentView, parentIndex) {
      var t1 = new M._ViewHeroTeamComponent1(null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeLiteral(["$implicit", null]), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex, null));
      t1.componentType = $.ViewHeroTeamComponent0__renderType;
      return H.assertSubtype(t1, "$isAppView", [V.HeroTeamComponent], "$asAppView");
    }, "call$2", "hero_team_component_template__viewFactory_HeroTeamComponent1$closure", 4, 0, 38],
    viewFactory_HeroTeamComponentHost0: [function(parentView, parentIndex) {
      var t1 = new M._ViewHeroTeamComponentHost0(null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex, null));
      return t1;
    }, "call$2", "hero_team_component_template__viewFactory_HeroTeamComponentHost0$closure", 4, 0, 4],
    initReflector6: function() {
      if ($._visited4)
        return;
      $._visited4 = true;
      E.initReflector0();
      $.$get$_components().$indexSet(0, C.Type_HeroTeamComponent_ckJ, C.ComponentFactory_iJM);
    },
    ViewHeroTeamComponent0: {
      "^": "AppView;_hero_team_component_template$_el_0,_hero_team_component_template$_el_2,_appEl_3,_NgFor_3_7,_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewHeroTeamComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("hero-team");
        this.rootEl = H.interceptedTypeCheck(t1, "$isHtmlElement");
        t1 = $.ViewHeroTeamComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_ad2);
          $.ViewHeroTeamComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        doc = document;
        t1 = S.createAndAppend(doc, "h3", parentRenderNode);
        this._hero_team_component_template$_el_0 = t1;
        this.addShimE$1(t1);
        _text_1 = doc.createTextNode("Team");
        J.append$1$x(this._hero_team_component_template$_el_0, _text_1);
        t1 = H.interceptedTypeCheck(S.createAndAppend(doc, "ul", parentRenderNode), "$isUListElement");
        this._hero_team_component_template$_el_2 = t1;
        this.addShimC$1(t1);
        t1 = $.$get$ngAnchor();
        _anchor_3 = (t1 && C.Comment_methods).clone$1(t1, false);
        t1 = this._hero_team_component_template$_el_2;
        (t1 && C.UListElement_methods).append$1(t1, _anchor_3);
        t1 = new V.ViewContainer(3, 2, this, _anchor_3, null, null, null);
        this._appEl_3 = t1;
        this._NgFor_3_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, H.interceptedTypeCheck(M.hero_team_component_template__viewFactory_HeroTeamComponent1$closure(), "$isFunction")));
        this.init$2(C.List_empty0, null);
        return;
      },
      detectChangesInternal$0: function() {
        var currVal_0, t1, t2, changes, collection;
        currVal_0 = H.interceptedTypeCheck(this.ctx, "$isHeroTeamComponent").hero.team;
      ...
      $asAppView: function() {
        return [V.HeroTeamComponent];
      },
      static: {
        ViewHeroTeamComponent0$: function(parentView, parentIndex) {
          var t1 = new M.ViewHeroTeamComponent0(null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
          t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex, null));
          t1.ViewHeroTeamComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewHeroTeamComponent1: {
      "^": "AppView;_hero_team_component_template$_el_0,_text_1,_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
        ...
        t1 = doc.createTextNode("");
        this._text_1 = t1;
        J.append$1$x(this._hero_team_component_template$_el_0, t1);
        this.init0$1(this._hero_team_component_template$_el_0);
        return;
      },
      detectChangesInternal$0: function() {
    ...
    _ViewHeroTeamComponentHost0: {
      "^": "AppView;_hero_team_component_template$_compView_0,_HeroTeamComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = M.ViewHeroTeamComponent0$(this, 0);
        this._hero_team_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new V.HeroTeamComponent(null);
        this._HeroTeamComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        H.assertSubtypeOfRuntimeType(t2, H.getRuntimeTypeArgument(t1, "AppView", 0));
        t1.set$ctx(t2);
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroTeamComponent_0_4, [V.HeroTeamComponent]);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_HeroTeamComponent_ckJ && 0 === nodeIndex)
          return this._HeroTeamComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._hero_team_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._hero_team_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      },
      $asAppView: Isolate.functionThatReturnsNull
    }
  }], ["", "package:component_styles/src/quest_summary_component.dart",, X, {
    "^": "",
    QuestSummaryComponent: {
      "^": "Object;"
    }
  }], ["", "package:component_styles/src/quest_summary_component.template.dart",, S, {
    "^": "",
    viewFactory_QuestSummaryComponentHost0: [function(parentView, parentIndex) {
      var t1 = new S._ViewQuestSummaryComponentHost0(null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex, null));
      return t1;
    }, "call$2", "quest_summary_component_template__viewFactory_QuestSummaryComponentHost0$closure", 4, 0, 4],
    initReflector5: function() {
      if ($._visited2)
        return;
      $._visited2 = true;
      E.initReflector0();
      $.$get$_components().$indexSet(0, C.Type_QuestSummaryComponent_guV, C.ComponentFactory_SYB);
    },
    ViewQuestSummaryComponent0: {
      "^": "AppView;_quest_summary_component_template$_el_0,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewQuestSummaryComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("quest-summary");
        this.rootEl = H.interceptedTypeCheck(t1, "$isHtmlElement");
        t1 = $.ViewQuestSummaryComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_P1j);
          $.ViewQuestSummaryComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, _text_1;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._quest_summary_component_template$_el_0 = t1;
        this.addShimE$1(t1);
        _text_1 = doc.createTextNode("No quests in progress");
        J.append$1$x(this._quest_summary_component_template$_el_0, _text_1);
        this.init$2(C.List_empty0, null);
        return;
      },
      $asAppView: function() {
        return [X.QuestSummaryComponent];
      },
      static: {
        ViewQuestSummaryComponent0$: function(parentView, parentIndex) {
          var t1 = new S.ViewQuestSummaryComponent0(null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
          t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex, null));
          t1.ViewQuestSummaryComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewQuestSummaryComponentHost0: {
      "^": "AppView;_quest_summary_component_template$_compView_0,_QuestSummaryComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = S.ViewQuestSummaryComponent0$(this, 0);
        this._quest_summary_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new X.QuestSummaryComponent();
        this._QuestSummaryComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        H.assertSubtypeOfRuntimeType(t2, H.getRuntimeTypeArgument(t1, "AppView", 0));
        t1.set$ctx(t2);
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._QuestSummaryComponent_0_4, [X.QuestSummaryComponent]);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_QuestSummaryComponent_guV && 0 === nodeIndex)
          return this._QuestSummaryComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._quest_summary_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._quest_summary_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      },
      $asAppView: Isolate.functionThatReturnsNull
  ...
  J.get$activate$x = function(receiver) {
    return J.getInterceptor$x(receiver).get$activate(receiver);
  };
  ...
  C.ComponentFactory_AZi = new D.ComponentFactory("hero-details", Q.hero_details_component_template__viewFactory_HeroDetailsComponentHost0$closure(), C.List_empty0, [U.HeroDetailsComponent]);
  C.ComponentFactory_QoR = new D.ComponentFactory("hero-app-main", N.hero_app_main_component_template__viewFactory_HeroAppMainComponentHost0$closure(), C.List_empty0, [V.HeroAppMainComponent]);
  C.ComponentFactory_SYB = new D.ComponentFactory("quest-summary", S.quest_summary_component_template__viewFactory_QuestSummaryComponentHost0$closure(), C.List_empty0, [X.QuestSummaryComponent]);
  C.ComponentFactory_af1 = new D.ComponentFactory("hero-controls", T.hero_controls_component_template__viewFactory_HeroControlsComponentHost0$closure(), C.List_empty0, [R.HeroControlsComponent]);
  C.ComponentFactory_hkD = new D.ComponentFactory("hero-app", V.app_component_template__viewFactory_AppComponentHost0$closure(), C.List_empty0, [Q.AppComponent]);
  C.ComponentFactory_iJM = new D.ComponentFactory("hero-team", M.hero_team_component_template__viewFactory_HeroTeamComponentHost0$closure(), C.List_empty0, [V.HeroTeamComponent]);
...
;
  ...
  C.List_2bx = Isolate.makeConstantList(["h1._ngcontent-%COMP% { font-weight:normal; }"]);
  ...
  C.List_jdl = Isolate.makeConstantList(["._nghost-%COMP% { display:block; background-color:green; color:white; }"]);
  C.List_P1j = Isolate.makeConstantList([C.List_jdl]);
  ...
  C.List_apl = Isolate.makeConstantList(["li._ngcontent-%COMP% { list-style-type:square; }"]);
  C.List_ad2 = Isolate.makeConstantList([C.List_apl]);
  ...
  C.List_gc6 = Isolate.makeConstantList(["button._ngcontent-%COMP% { background-color:white; border:1px solid #777; }"]);
  C.List_nxB = H.setRuntimeTypeInfo(Isolate.makeConstantList([0, 0, 24576, 1023, 65534, 34815, 65534, 18431]), [P.int]);
  C.List_0 = Isolate.makeConstantList(['._nghost-%COMP% { padding:10px; } h2._ngcontent-%COMP%::after { content:" (from imported CSS)"; }']);
  C.List_RY3 = Isolate.makeConstantList(["._nghost-%COMP% { display:block; border:1px solid black; } ._nghost-%COMP%.active { border-width:3px; } ._nghost-%COMP%.theme-light h2._ngcontent-%COMP%,.theme-light ._nghost-%COMP% h2._ngcontent-%COMP% { background-color:#eef; } ._nghost-%COMP%  h3 { font-style:italic; }", C.List_0]);
  C.List_pSP = Isolate.makeConstantList([C.List_RY3]);
  ...
  C.Type_HeroAppMainComponent_P1W = H.createRuntimeType("HeroAppMainComponent");
  C.Type_HeroControlsComponent_soA = H.createRuntimeType("HeroControlsComponent");
  C.Type_HeroDetailsComponent_MU4 = H.createRuntimeType("HeroDetailsComponent");
  C.Type_HeroTeamComponent_ckJ = H.createRuntimeType("HeroTeamComponent");
  ...
  C.Type_QuestSummaryComponent_guV = H.createRuntimeType("QuestSummaryComponent");
  ...
  $._visited0 = false;
  $.ViewHeroAppMainComponent0__renderType = null;
  $._visited1 = false;
  $.ViewHeroControlsComponent0__renderType = null;
  $._visited5 = false;
  $.ViewHeroDetailsComponent0__renderType = null;
  $._visited3 = false;
  $.ViewHeroTeamComponent0__renderType = null;
  $._visited4 = false;
  $.ViewQuestSummaryComponent0__renderType = null;
  $._visited2 = false;
  ...
  $ = new Isolate();
  init.metadata = [null, "_", "error", "p0", "line", "zone", "stackTrace", "self", "parent", "arg", "trace", "frame", "result", "p1", "callback", "value", "invocation", "f", "arg1", "arg2", "elem", "x", "t", "e", "p2", "deps", "findInAncestors", "arg3", "theStackTrace", "closure", "encodedComponent", "s", "o", "ref", "err", "object", "arg4", "zoneValues", "index", "arguments", "event", "fn", "chain", "sender", "clazz", "isolate", "factory", "stack", "reason", "item", "numberOfArguments", "binding", "exactMatch", true, "errorCode", "didWork_", "each", "theError", "specification", "element"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, ret: S.AppView, args: [S.AppView, P.num]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [P.int,,]}, {func: 1, args: [P.bool]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, v: true, args: [P.Uint8List, P.String, P.int]}, {func: 1, ret: P.Future}, {func: 1, ret: P.String}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, v: true}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, v: true, args: [P.String, P.int]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Uint8List, args: [,,]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [P.String,,]}, {func: 1, args: [R.CollectionChangeRecord, P.int, P.int]}, {func: 1, args: [Y.NgZoneError]}, {func: 1, args: [Y.PlatformRefImpl, Y.NgZone, M.Injector]}, {func: 1, args: [P.String, E.SanitizationService, N.EventManager]}, {func: 1, args: [M.ComponentLoader, V.ComponentResolver]}, {func: 1, args: [Y.NgZone]}, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, v: true, args: [, U.Chain]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1}]}, {func: 1, ret: P.Object, args: [P.Type], named: {deps: [P.List, P.Object]}}, {func: 1, ret: P.Object, args: [P.Object]}, {func: 1, ret: P.Object, args: [P.Function], named: {deps: [P.List, P.Object]}}, {func: 1, v: true, args: [,], opt: [, P.String]}, {func: 1, ret: [S.AppView, V.HeroTeamComponent], args: [S.AppView, P.num]}, {func: 1, v: true, args: [P.Function]}, {func: 1, ret: P.List, args: [W.Element], opt: [P.String, P.bool]}, {func: 1, args: [W.Element], opt: [P.bool]}, {func: 1, args: [W.Element, P.bool]}, {func: 1, args: [P.List, Y.NgZone]}, {func: 1, args: [V.HammerGestureConfig]}, {func: 1, ret: P.int, args: [[P.List, P.int], P.int]}, {func: 1, v: true, args: [P.int, P.int]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, v: true, args: [P.Object]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: [P.List, N.EventManagerPlugin]}, {func: 1, ret: Y.NgZone}, {func: 1, args: [, P.String]}, {func: 1, ret: P.bool}];
