...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, null, null, 14, 0, null, 55, 51, 43, 16, 19, 25, 33],
    ...
    Primitives_functionNoSuchMethod_closure: {
      "^": "Closure:68;_box_0,$arguments,namedArgumentList",
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 59, 18],
    ...
    _rootFork: [function($self, $parent, zone, specification, zoneValues) {
      ...
      return t1;
    }, "call$5", "async___rootFork$closure", 10, 0, 65, 1, 2, 3, 40, 30],
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 23, 5, 8],
    ...
    initReflector_closure13: {
      ...
      }, null, null, 6, 0, null, 7, 12, 23, "call"]
    }
    ...
    NgZone: {
      ...
      }, "call$4", "get$_ng_zone$_scheduleMicrotask", 8, 0, 11, 1, 2, 3, 9],
      ...
      }, "call$5", "get$_onErrorWithoutLongStackTrace", 10, 0, 15, 1, 2, 3, 5, 44],
      ...
      }, "call$5", "get$_createTimer", 10, 0, 49, 1, 2, 3, 45, 9],
    ...
    _RuntimeInjector: {
      ...
      useClass$2$deps: [function(clazz, deps) {
        ...
        return t1;
      }, null, "get$useClass", 2, 3, null, 4, 46, 47]
    },
    _FlatProviders: {
    ...
    BrowserExceptionHandler: {
      ...
      }, "call$2", null, null, null, "get$$call", 2, 4, null, 4, 4, 5, 48, 49]
    }
    ...
    PublicTestability: {
      ...
      }, "call$1", "get$whenStable", 2, 0, 6, 14],
      ...
      }, "findBindings$2", "call$3", "call$1", "call$2", "get$findBindings", 2, 4, 52, 4, 4, 17, 52, 53],
    ...
    BrowserGetTestability_addToWindow_closure: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 54, 17, 20, "call"]
    },
    ...
    ViewAppComponent0: {
      "^": "AppView;_app_component_template$_el_0,_app_component_template$_el_2,_app_component_template$_compView_2,_HeroAppMainComponent_2_4,_expr_0,_app_component_template$_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
    ...
    _ViewAppComponentHost0: {
      ...
      build$0: function() {
        var t1, t2, t3;
        t1 = new V.ViewAppComponent0(null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), this, null, null, null);
        t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, 0);
        t2 = document.createElement("hero-app");
        t1.rootEl = t2;
        t2 = $.ViewAppComponent0__renderType;
        if (t2 == null) {
          t2 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_2bx);
        ...
        t2 = new Q.AppComponent(new G.Hero(false, "Human Torch", ["Mister Fantastic", "Invisible Woman", "Thing"]));
    ...
    viewFactory_HeroAppMainComponentHost0: [function(parentView, parentIndex) {
      var t1 = new N._ViewHeroAppMainComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    ...
    ViewHeroAppMainComponent0: {
      ...
      build$0: function() {
        ...
        t2 = this._hero_app_main_component_template$_compView_0;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        t2 = Q.ViewHeroDetailsComponent0$(this, 1);
        this._compView_1 = t2;
        t2 = t2.rootEl;
        this._el_1 = t2;
        parentRenderNode.appendChild(t2);
        this._HeroDetailsComponent_1_4 = new U.HeroDetailsComponent(null);
        t2 = T.ViewHeroControlsComponent0$(this, 2);
        this._hero_app_main_component_template$_compView_2 = t2;
        this._hero_app_main_component_template$_el_2 = t2.rootEl;
        t1 = new R.HeroControlsComponent(null);
        this._HeroControlsComponent_2_4 = t1;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        t2 = this._compView_1;
        t1 = this._HeroDetailsComponent_1_4;
        t3 = this._hero_app_main_component_template$_el_2;
        t2.ctx = t1;
      ...
      detectChangesInternal$0: function() {
        var _ctx, currVal_1, t1, currVal_2, currVal_0, t2;
        _ctx = this.ctx;
        currVal_1 = _ctx.get$hero();
        t1 = this._expr_1;
        if (t1 == null ? currVal_1 != null : t1 !== currVal_1) {
          this._HeroDetailsComponent_1_4.hero = currVal_1;
          this._expr_1 = currVal_1;
        }
        currVal_2 = _ctx.get$hero();
        t1 = this._expr_2;
        if (t1 == null ? currVal_2 != null : t1 !== currVal_2) {
          this._HeroControlsComponent_2_4.hero = currVal_2;
          this._expr_2 = currVal_2;
        }
        currVal_0 = _ctx.get$hero().active;
        if (this._hero_app_main_component_template$_expr_0 !== currVal_0) {
          t1 = this._el_1;
          t2 = J.getInterceptor$x(t1);
          if (currVal_0)
            t2.get$classes(t1).add$1(0, "active");
          else
            t2.get$classes(t1).remove$1(0, "active");
      ...
      static: {
        ViewHeroAppMainComponent0$: function(parentView, parentIndex) {
          var t1 = new N.ViewHeroAppMainComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
    ...
    _ViewHeroAppMainComponentHost0: {
      ...
      build$0: function() {
        ...
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroAppMainComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
    ...
    viewFactory_HeroControlsComponentHost0: [function(parentView, parentIndex) {
      var t1 = new T._ViewHeroControlsComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    ...
    ViewHeroControlsComponent0: {
      ...
      build$0: function() {
        var parentRenderNode, doc, t1, _text_1, _text_3;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        ...
        t1 = S.createAndAppend(doc, "button", parentRenderNode);
        this._el_2 = t1;
        this.addShimC$1(t1);
        _text_3 = doc.createTextNode("Activate");
        this._el_2.appendChild(_text_3);
        J._addEventListener$3$x(this._el_2, "click", this.eventHandler0$1(J.get$activate$x(this.ctx)), null);
        this.init$2(C.List_empty, null);
        return;
      },
      static: {
        ViewHeroControlsComponent0$: function(parentView, parentIndex) {
          var t1 = new T.ViewHeroControlsComponent0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
    ...
    _ViewHeroControlsComponentHost0: {
      "^": "AppView;_compView_0,_HeroControlsComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        ...
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroControlsComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
    ...
    viewFactory_HeroDetailsComponentHost0: [function(parentView, parentIndex) {
      var t1 = new Q._ViewHeroDetailsComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    ...
    ViewHeroDetailsComponent0: {
      "^": "AppView;_hero_details_component_template$_el_0,_hero_details_component_template$_text_1,_hero_details_component_template$_el_2,_compView_2,_HeroTeamComponent_2_4,_hero_details_component_template$_expr_0,_hero_details_component_template$_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      ...
      build$0: function() {
        ...
        this._hero_details_component_template$_el_0.appendChild(t1);
      ...
      detectChangesInternal$0: function() {
        ...
        _ctx = this.ctx;
        currVal_1 = _ctx.get$hero();
        t1 = this._hero_details_component_template$_expr_1;
        if (t1 == null ? currVal_1 != null : t1 !== currVal_1) {
          this._HeroTeamComponent_2_4.hero = currVal_1;
          this._hero_details_component_template$_expr_1 = currVal_1;
        }
        currVal_0 = Q.interpolate0(_ctx.get$hero().name);
      ...
      static: {
        ViewHeroDetailsComponent0$: function(parentView, parentIndex) {
          var t1 = new Q.ViewHeroDetailsComponent0(null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
    ...
    _ViewHeroDetailsComponentHost0: {
      ...
      build$0: function() {
        ...
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroDetailsComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
    ...
    viewFactory_HeroTeamComponent1: [function(parentView, parentIndex) {
      var t1 = new M._ViewHeroTeamComponent1(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewHeroTeamComponent0__renderType;
      return t1;
    }, "call$2", "hero_team_component_template__viewFactory_HeroTeamComponent1$closure", 4, 0, 45],
    viewFactory_HeroTeamComponentHost0: [function(parentView, parentIndex) {
      var t1 = new M._ViewHeroTeamComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    ...
    ViewHeroTeamComponent0: {
      "^": "AppView;_hero_team_component_template$_el_0,_hero_team_component_template$_el_2,_appEl_3,_NgFor_3_7,_hero_team_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      ...
      build$0: function() {
        ...
        this._hero_team_component_template$_el_0.appendChild(_text_1);
        ...
        this._hero_team_component_template$_el_2.appendChild(_anchor_3);
        t1 = new V.ViewContainer(3, 2, this, _anchor_3, null, null, null);
        this._appEl_3 = t1;
        this._NgFor_3_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, M.hero_team_component_template__viewFactory_HeroTeamComponent1$closure()));
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        var currVal_0, t1, t2, changes, collection;
        currVal_0 = this.ctx.get$hero().team;
        if (this._hero_team_component_template$_expr_0 !== currVal_0) {
          t1 = this._NgFor_3_7;
          ...
          this._hero_team_component_template$_expr_0 = currVal_0;
        }
        t1 = this._NgFor_3_7;
        changes = t1._differ;
        if (changes != null) {
      ...
      static: {
        ViewHeroTeamComponent0$: function(parentView, parentIndex) {
          var t1 = new M.ViewHeroTeamComponent0(null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
    ...
    _ViewHeroTeamComponent1: {
      "^": "AppView;_hero_team_component_template$_el_0,_text_1,_hero_team_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
        ...
        t1 = doc.createTextNode("");
        this._text_1 = t1;
        this._hero_team_component_template$_el_0.appendChild(t1);
    ...
    _ViewHeroTeamComponentHost0: {
      ...
      build$0: function() {
        ...
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroTeamComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
    ...
    viewFactory_QuestSummaryComponentHost0: [function(parentView, parentIndex) {
      var t1 = new S._ViewQuestSummaryComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    ...
    ViewQuestSummaryComponent0: {
      ...
      build$0: function() {
        ...
        this._quest_summary_component_template$_el_0.appendChild(_text_1);
        this.init$2(C.List_empty, null);
        return;
      },
      static: {
        ViewQuestSummaryComponent0$: function(parentView, parentIndex) {
          var t1 = new S.ViewQuestSummaryComponent0(null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
    ...
    _ViewQuestSummaryComponentHost0: {
      ...
      build$0: function() {
        ...
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._QuestSummaryComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_QuestSummaryComponent_guV && 0 === nodeIndex)
  ...
  C.ComponentFactory_AZi = new D.ComponentFactory("hero-details", Q.hero_details_component_template__viewFactory_HeroDetailsComponentHost0$closure(), C.List_empty, [U.HeroDetailsComponent]);
  C.ComponentFactory_QoR = new D.ComponentFactory("hero-app-main", N.hero_app_main_component_template__viewFactory_HeroAppMainComponentHost0$closure(), C.List_empty, [V.HeroAppMainComponent]);
  C.ComponentFactory_SYB = new D.ComponentFactory("quest-summary", S.quest_summary_component_template__viewFactory_QuestSummaryComponentHost0$closure(), C.List_empty, [X.QuestSummaryComponent]);
  C.ComponentFactory_af1 = new D.ComponentFactory("hero-controls", T.hero_controls_component_template__viewFactory_HeroControlsComponentHost0$closure(), C.List_empty, [R.HeroControlsComponent]);
  C.ComponentFactory_hkD = new D.ComponentFactory("hero-app", V.app_component_template__viewFactory_AppComponentHost0$closure(), C.List_empty, [Q.AppComponent]);
  C.ComponentFactory_iJM = new D.ComponentFactory("hero-team", M.hero_team_component_template__viewFactory_HeroTeamComponentHost0$closure(), C.List_empty, [V.HeroTeamComponent]);
...
;
  ...
  $ = new Isolate();
  init.metadata = ["index", "self", "parent", "zone", null, "error", "_", "p0", "stackTrace", "fn", "arg", "result", "p1", "f", "callback", "invocation", "arg1", "elem", "value", "arg2", "findInAncestors", "e", "x", "p2", "data", "arg3", "errorCode", "theError", "sender", "object", "zoneValues", "k", "v", "arg4", "name", "theStackTrace", "ref", "err", "arguments", "each", "specification", "item", "t", "numberOfArguments", "trace", "duration", "clazz", "deps", "stack", "reason", "event", "isolate", "binding", "exactMatch", true, "closure", "didWork_", "o", "element"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, ret: S.AppView, args: [S.AppView, P.num]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, v: true, args: [P.Function]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: W.MimeType, args: [P.int]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, v: true}]}, {func: 1, ret: P.String}, {func: 1, args: [P.int,,]}, {func: 1, ret: P.Future}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: W.Node, args: [P.int]}, {func: 1, ret: W.Element, args: [P.int]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: W.File, args: [P.int]}, {func: 1, ret: P.Object, opt: [P.Object]}, {func: 1, ret: W.DataTransferItem, args: [P.int]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, ret: W.Plugin, args: [P.int]}, {func: 1, ret: [P.List, W.RtcStatsReport]}, {func: 1, ret: W.SourceBuffer, args: [P.int]}, {func: 1, ret: W.SpeechGrammar, args: [P.int]}, {func: 1, ret: W.SpeechRecognitionAlternative, args: [P.int]}, {func: 1, ret: W.Touch, args: [P.int]}, {func: 1, ret: W.TrackDefault, args: [P.int]}, {func: 1, ret: W.VttRegion, args: [P.int]}, {func: 1, ret: P.Rectangle, args: [P.int]}, {func: 1, ret: W.CssRule, args: [P.int]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: W._Attr, args: [P.int]}, {func: 1, ret: W.SpeechRecognitionResult, args: [P.int]}, {func: 1, ret: W.StyleSheet, args: [P.int]}, {func: 1, v: true, opt: [P.Object]}, {func: 1, ret: P.Map, args: [P.int]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [R.CollectionChangeRecord, P.int, P.int]}, {func: 1, args: [Y.NgZoneError]}, {func: 1, args: [Y.PlatformRefImpl, Y.NgZone, M.Injector]}, {func: 1, args: [P.String, E.SanitizationService, N.EventManager]}, {func: 1, ret: [S.AppView, V.HeroTeamComponent], args: [S.AppView, P.num]}, {func: 1, args: [Y.NgZone]}, {func: 1, args: [P.String]}, {func: 1, args: [, P.String]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1}]}, {func: 1, v: true, args: [,], opt: [, P.String]}, {func: 1, ret: P.bool}, {func: 1, ret: P.List, args: [W.Element], opt: [P.String, P.bool]}, {func: 1, args: [W.Element], opt: [P.bool]}, {func: 1, args: [P.bool]}, {func: 1, args: [W.Element, P.bool]}, {func: 1, args: [P.List, Y.NgZone]}, {func: 1, args: [V.HammerGestureConfig]}, {func: 1, args: [M.ComponentLoader, V.ComponentResolver]}, {func: 1, v: true, args: [P.Object]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, ret: [P.List, N.EventManagerPlugin]}, {func: 1, ret: Y.NgZone}, {func: 1, args: [P.String,,]}, {func: 1, ret: W.Gamepad, args: [P.int]}];
